...
class ApiController extends Controller {
    ...
    protected function _initialize(){
        ...
        if ( $access === false ) {
            $this->ajaxReturn(array('errno' => 403, 'errmsg' => 'Forbidden to access.'));
        }elseif( $access === null ){
            ...
            if( $dynamic === null ){
                ...
                if ( !$this->checkRule($rule,array('in','1,2')) ){
                    $this->ajaxReturn(array('errno' => 403, 'errmsg' => 'Unauthorized access.'));
                }
    ...
    protected function login(){
        /* 用户登录检测 */
        is_login() || $this->ajaxReturn(array('errno' => 1, 'errmsg' => 'Please sign in.'));
    }
