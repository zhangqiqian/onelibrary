            ...
            <ul class="nav navbar-nav navbar-right">
                <?php if(is_login()): ?><li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>
                                <li><a href="<?php echo U('User/logout');?>">Logout</a></li>
                            </ul>
                        </li>
                <?php else: ?>
                        <li>
...
<form class="form-signin" action="/index.php?s=/User/register.html" method="post" role="form">
      ...
      <img class="verifyimg reloadverify" title="Click to switch" alt="Click to switch" src="<?php echo U('verify');?>" style="cursor:pointer;">
